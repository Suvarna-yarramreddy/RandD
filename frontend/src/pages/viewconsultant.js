            ...
            {consultancyProjects.length > 0 ? (
                <div className="row">
                    {consultancyProjects.map(project => (
                        <div className="col-md-6 mb-4" key={project.consultancy_id}> {/* Fixed: Use project.id */}
                            <div className="card">
                                <div className="card-body flex-column">
                                    <h5 className="card-title">
                                        ...
                                        <a
                                            href="#!"
                                            onClick={() => handleToggleDetails(project.consultancy_id)} // Fixed: Use project.id
                                            className="text-primary"
                                        >
                                            {project.titleofconsultancy}
                                        </a>
                                    </h5>
                                    {visibleDetails === project.consultancy_id && ( // Fixed: Use project.id
